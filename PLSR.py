...
features_saved = ['Chla_center', 'Tw_center', 'Kd_center', 'PAR_center', 'Chla*Tw', 'Log(Chla*Tw)', 'Chla*Kd', 'TW*Kd', 'Kd*Par', 'WS_m/s']
target = 'log10_Fm_¦Ìmol/m2/d'
...
# Average CV score on the training set was: -0.3642162754162845
