...
# Average CV score on the training set was: -0.41783704427976714
exported_pipeline = make_pipeline(
    MinMaxScaler(),
    GradientBoostingRegressor(alpha=0.85, learning_rate=0.1, loss="lad", max_depth=7, max_features=0.15000000000000002, min_samples_leaf=17, min_samples_split=9, n_estimators=100, subsample=0.6000000000000001)
)
